...
public class Gallery {
    ...
    public String addCurator(String userID, String fname,String lname, String commission){
        String msg = "";
        if(userID.length() != 5){
    ...
    public String addArtist(String ArtistID, String curatorID, String fname, String lname){
        String msg = "";
        if(ArtistID.length() != 5){
            ...
            if(ArtistIdVerifier(ArtistID) == true){
                ...
                msg = "Please enter the curatorID associated with this artistID: ";

                if(CuratorIdVerifier(curatorID) != true){
                    msg = "Error! There is no Curator with this ID";
                }
                else{
                    ...
                    if(fname.length() + lname.length() > 30){
                        ...
                        Artist artist = new Artist(ArtistID, curatorID, fname, lname);
    ...
    public String addPiece(String peiceID, String artistID, String curtorID, String title, double estimate, int year){
        String msg;
        if(peiceID.length() != 5){
           msg = "Error! PeiceID should be exactly 5 characters!";
        }
        else{
            if(peiceVerifier(peiceID) == true){
    ...
    public void CommissionUpdate(String ArtPieceID,
                                double price, double estimate){
        String curatorID="";
        for(ArtPiece piece : myArtPieces){
            if(piece.getPieceID().equals(ArtPieceID)){
        ...
        if(peiceVerifier(artPieceID) != true){
            ...
            if(statusChecker(artPieceID) != 'D'){
                ...
                if(price >= getEstimate(artPieceID)){
                    ...
                    CommissionUpdate(artPieceID, price, estimate);
    ...
    public String sellArtPiece(String artPieceID, double price){
        ...
        String msg = "";
        if(peiceVerifier(artPieceID) != true){
            msg = "Error! These is no Artpiece with this ID!";
        }
        else{
            if(statusChecker(artPieceID) != 'D'){
